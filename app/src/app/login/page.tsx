...
const ROLES = [
  { key: "student", label: "Student", icon: "school", bg: "#FDE1E4", color: "var(--color-brand-primary)" },
...
function PrimaryButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="w-full rounded-full py-3.5 text-sm font-bold transition-[transform,background-color,color,border-color] duration-200 ease-out active:scale-[0.98]"
      style={
        disabled
          ? {
    ...
    return (
      <div className="relative flex flex-1 flex-col">
        <div
          ...
          style={{ background: "linear-gradient(180deg, #E9394F 0%, #8E1526 100%)", minHeight: 360 }}
        >
      ...
      <main className="flex flex-1 flex-col px-6 pb-8">
        {step === "phone" && (
          <div className="flex flex-1 flex-col justify-center">
            ...
            <div
              className="mb-4 flex items-center gap-2 rounded-full border-2 border-transparent px-4 py-3.5 transition-colors duration-150 ease-out has-[:focus-visible]:border-[var(--color-brand-primary)]"
            ...
            <div className="mb-4 grid grid-cols-6 gap-2">
              {otp.map((digit, i) => (
                <input
                  ...
                  inputMode="numeric"
                  maxLength={6}
                  className="aspect-square w-full min-w-0 rounded-[10px] border border-[var(--color-border)] text-center text-base font-bold text-[var(--color-text-primary)] outline-none transition-colors duration-150 ease-out focus:border-[var(--color-brand-primary)]"
                />
              ))}
            </div>
        ...
        {step === "name" && (
          <div className="flex flex-1 flex-col justify-center">
            ...
            <input
              ...
              className="mb-6 w-full rounded-full border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2.5 text-sm text-[var(--color-text-primary)] outline-none transition-colors duration-150 ease-out placeholder:text-[var(--color-text-secondary)] focus:border-[var(--color-brand-primary)]"
            />
        ...
        {step === "class" && (
          <div className="flex flex-1 flex-col justify-center">
            ...
            <select
              ...
              className="mb-6 w-full rounded-full border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2.5 text-sm text-[var(--color-text-primary)] outline-none transition-colors duration-150 ease-out focus:border-[var(--color-brand-primary)]"
            >
        ...
        {step === "location" && (
          <div className="flex flex-1 flex-col justify-center">
            ...
            <select
              ...
              className="mb-3 w-full rounded-full border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2.5 text-sm text-[var(--color-text-primary)] outline-none transition-colors duration-150 ease-out focus:border-[var(--color-brand-primary)]"
            >
            ...
            <select
              ...
              disabled={!division}
              className="mb-6 w-full rounded-full border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2.5 text-sm text-[var(--color-text-primary)] outline-none transition-colors duration-150 ease-out focus:border-[var(--color-brand-primary)] disabled:opacity-50"
            >
